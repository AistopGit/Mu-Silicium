...
class CommonPlatform ():
    PackagesSupported = ("ja3gxxPkg")
    ArchSupported = ("ARM")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('ja3gxx', 'gcc_arm_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def AddCommandLineOptions (self, parserObj):
        parserObj.add_argument('-a', "--arch", dest="build_arch", type=str, default="ARM", help="Optional - CSV of architecture to build. ARM is used for PEI and DXE and is the only valid option for this platform.")

    def RetrieveCommandLineOptions (self, args):
        if args.build_arch.upper() != "ARM":
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "ja3gxx", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "ja3gxxPkg/ja3gxx.dsc", "Platform Hardcoded")
